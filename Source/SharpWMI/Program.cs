...
";
        ...
        public static void LocalWMIQuery(string wmiQuery, string wmiNameSpace = "")
        {
        ...
        public static void RemoteWMIQuery(string host, string wmiQuery, string wmiNameSpace, string username, string password)
        {
            if (wmiNameSpace == "")
            {
        ...
        public static void RemoteWMIExecute(string host, string command, string username, string password)
        {
        ...
        public static void RemoteWMIExecuteVBS(string host, string eventName, string username, string password)
        {
            try
            {
                ConnectionOptions options = new ConnectionOptions();
